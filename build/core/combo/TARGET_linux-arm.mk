...
# defines in build/core/combo/include/arch/<combo>/vmWorksConfig.h. Their
# purpose is to allow module $(VMW_MAKEFILE_NAME) files to selectively compile
...
#$(combo_2nd_arch_prefix)TARGET_GCC_VERSION := 4.3.3
$(combo_2nd_arch_prefix)TARGET_GCC_VERSION := 4.6
else
...
#$(combo_2nd_arch_prefix)TARGET_TOOLCHAIN_ROOT := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-none-linux-gnueabi-$($(combo_2nd_arch_prefix)TARGET_GCC_VERSION)
#$(combo_2nd_arch_prefix)TARGET_TOOLS_PREFIX := $($(combo_2nd_arch_prefix)TARGET_TOOLCHAIN_ROOT)/bin/arm-none-linux-gnueabi-
endif
...
vmworks_config_h := $(call select-vmworks-config-h,linux-arm)
...
$(combo_2nd_arch_prefix)TARGET_GLOBAL_CFLAGS += \
			...
			-fno-short-enums \
			$(arch_variant_cflags) \
			-include $(vmworks_config_h) \
			-I $(dir $(vmworks_config_h))
...
ifneq ($(strip $(BUILD_FDO_INSTRUMENT)),)
  ...
  $(combo_2nd_arch_prefix)TARGET_FDO_CFLAGS := -fprofile-generate=/data/local/tmp/profile
  ...
  ifneq ($(strip $(wildcard $($(combo_2nd_arch_prefix)TARGET_FDO_PROFILE_PATH))),)
    $(combo_2nd_arch_prefix)TARGET_FDO_CFLAGS := -fprofile-use=$($(combo_2nd_arch_prefix)TARGET_FDO_PROFILE_PATH)
    $(combo_2nd_arch_prefix)TARGET_FDO_LIB := $(target_libgcov)
  endif
endif


libc_inc := $(TARGET_TOOLCHAIN_ROOT)/arm-none-linux-gnueabi/libc/usr/include
libc++_inc := $(TARGET_TOOLCHAIN_ROOT)/include
